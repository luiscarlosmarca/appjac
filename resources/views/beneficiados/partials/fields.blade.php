<div class="col-sm-6">
		...
		<div class="form-group">
		  ...
		  <div class="form-group">
									...
									{!!Form::label('Fena', 'Fecha de Nacimiento AAAA-MM-DD') !!}
...
<div class="col-sm-6">
		...
		<div class="form-group">
		 ...
		 <div class="form-group">
		  ...
		  <div class="form-group">
									...
									{!!Form::label('Junta', 'Id de la Junta de Accion Comunal') !!}
							   		{!!Form::text('junta_id',null,['class'=>'form-control floating-label','requiered']) !!}
		 </div>
 		...
 		<div class="form-group">
									...
									{!!Form::label('Entidad', 'Entidad que Dirige el certificado') !!}
							   		{!!Form::text('entidad',null,['class'=>'form-control floating-label','requiered']) !!}
		 </div>
		...
		<div class="form-group">
									...
									{!!Form::label('feresidencia', 'Fecha de Residencia  AAAA-MM-DD') !!}
